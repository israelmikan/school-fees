...
<html lang="en" class="app">
    ...
    <body>
                        ...
                        <section class="vbox">          
                            <section class="scrollable padder">
                                <div class="m-b-md">
                                    ...
                                    <small>Change password for account</small>
                                </div>
                                <div class='row'>
                                    <div class='col-sm-10'>
                                        <section class="panel panel-default">
                                            <div class='panel-body'>
                                                ...
                                                <form id='frmChangePassword' name='frmChangePassword' action='setting/xhrChangePassword' role="form">
                                                    <input type="hidden" name="studentId" value="<?php echo session::get(SUserId); ?>" />
                                                    <div class="form-group col-md-12">
                                                        <label>Old password</label>
                                                        <input type="password" name='op' placeholder="Enter your old password" class="form-control input-lg">
                                                    </div>

                                                    <div class="form-group col-md-12">
                                                        <label>New password</label>
                                                        <input type="password" name='np' placeholder="Enter your new password" class="form-control input-lg">
                                                    </div>

                                                    <div class="form-group col-md-12">
                                                        <label>Confirm password</label>
                                                        <input type="password" name='cnp' placeholder="Confirm new password" class="form-control input-lg">
                                                    </div>

                                                    <div class="form-group col-md-12">
                                                        <div class="col-sm-4 col-sm-offset-2">
                                                            <button class="btn btn-default" id='cancel' type="button">Cancel</button>
                                                            <button class="btn btn-primary" id='frmSubmitChangePassword' type="button">Change password</button>
                                                        </div>
                                                    </div>
        ...
        <script type="text/javascript" src="<?php echo URL_javascript . '/settings.js' ?>" ></script>
    </body>
</html>